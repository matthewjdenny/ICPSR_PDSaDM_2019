...
# webpage above:
consumerKey <- "OT1cZj6Rh05udm6woYIM4giYl"
consumerSecret <- "ROFi6TzrB6hAUXt1xP0TETLLBTLspHroXNNCN6a7r6xAv75nKc"
...
save(my_oauth, file = "ISSR_oauth.RData")
